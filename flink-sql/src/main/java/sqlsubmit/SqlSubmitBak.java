...
import sqlsubmit.cli.CliOptions;
import sqlsubmit.cli.CliOptionsParser;
import sqlsubmit.cli.SqlCommandParser;

import java.nio.file.Files;
import java.nio.file.Paths;
import java.util.List;

public class SqlSubmitBak {

    public static void main(String[] args) throws Exception {
        final CliOptions options = CliOptionsParser.parseClient(args);
        SqlSubmitBak submit = new SqlSubmitBak(options);
        submit.run();
    }
    ...
    private SqlSubmitBak(CliOptions options) {
